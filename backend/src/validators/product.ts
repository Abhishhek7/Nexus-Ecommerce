...
const optionalPrice = z.preprocess((v) => v === '' || v === undefined ? undefined : v, z.coerce.number().min(0).optional());
const optionalBoolean = z.preprocess((v) => v === '' || v === undefined ? undefined : v, z.coerce.boolean().optional());
...
export const idParam = base.extend({ body: z.unknown(), query: z.unknown(), params: idParams });
